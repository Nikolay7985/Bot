...
"""
# Вернуть armore
# Сгенерировать четверку рыцарь маг лучник вор
# ---
# 1. Открывается окно с предложением собрать команду
# 2. Собрать пул 4х героев
# 3. Сгенерировать команду врага
# 4. Реализовать возможность боя
# 5. Выдать результат боя
